							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-charity' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-charity' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-charity' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-charity' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-charity' ) . ' </span>',
									));
								endif;
							?>
						</div><!-- #primary -->
